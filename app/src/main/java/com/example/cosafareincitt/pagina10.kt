...
class pagina10 : GenericPage(), OnMapReadyCallback {

    private lateinit var mMap: GoogleMap
    private lateinit var binding: ActivityPagina10Binding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_pagina10)
        binding = ActivityPagina10Binding.inflate(layoutInflater)
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        mMap = googleMap
//40.83474659298823, 14.335369655748611
        val marigliano = LatLng(40.83474659298823, 14.335369655748611)
        gestisci_mappa(mMap,marigliano,"Casa Marigliano",this)
