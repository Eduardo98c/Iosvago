...
import com.example.cosafareincitt.databinding.ActivityPagina17Binding
import java.util.*

class pagina17 : GenericPage(), OnMapReadyCallback {

    private lateinit var mMap: GoogleMap
    private lateinit var binding: ActivityPagina17Binding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_pagina17)
        binding = ActivityPagina17Binding.inflate(layoutInflater)
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        mMap = googleMap
//40.82300634335707, 14.390635969242055
        val duegolfi = LatLng(40.82300634335707, 14.390635969242055)
        gestisci_mappa(mMap,duegolfi,"Terrazza Due Golfi",this)
