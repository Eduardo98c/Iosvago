...
import com.example.cosafareincitt.databinding.ActivityPagina18Binding
import java.util.*

class pagina18 : GenericPage(), OnMapReadyCallback {

    private lateinit var mMap: GoogleMap
    private lateinit var binding: ActivityPagina18Binding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_pagina18)
        binding = ActivityPagina18Binding.inflate(layoutInflater)
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        mMap = googleMap
//40.90785224870874, 14.345831611573576
        val wine = LatLng(40.907852248708744, 14.345831611573576)
        gestisci_mappa(mMap,wine,"Pro Wine",this)
